  ...
  availableTabs.length > 8 && (
    <TabsList className="grid w-full mt-2" style={ { gridTemplateColumns, 8) }, 1fr)` }}>
          ...
          <TabsContent value="workspace" className="space-y-6">
            <div className="grid grid-cols-1 lg, relatórios e dashboards ficam salvos aqui.
                        <br />
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {activeModulesCount < 5 && (
                    <Button variant="outline" className="w-full justify-start border-dashed border-orange-300 text-orange-600 hover)}
                </CardContent>
              </Card>
            </div>
          </TabsContent>
                ...
                <CardContent className="p-6">
                  <div className="text-center text-muted-foreground py-8">
                    ...
                    <p className="text-sm">
                      ...
                      <br />
                      Ex, Vendas não vê dados de Compras.
                    </p>
                ...
                <CardContent className="p-6">
                  <div className="text-center text-muted-foreground py-8">
                    ...
                    <Alert className="mt-4 text-left">
                      <Lock className="h-4 w-4" />
                      <AlertDescription>
                        <strong>Permissões mantidas por usuário)}
