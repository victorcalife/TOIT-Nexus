...
export default function FunctionalAdmin() {
      ...
      <div className="bg-white shadow border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">TOIT NEXUS - Administração</h1>
              <p className="text-sm text-gray-500">Sistema de Gestão Completa</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full">Backup do Sistema</Button>
                </CardContent>
              </Card>
