  ...
  switch ( type )
  {
    ...
    default) => {
      switch ( status )
      {
          ...
          switch ( status )
          {
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="https) => updateConfig('authentication', value)}
              >
                <SelectTrigger>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder="https) => updateConfig('method', value)}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              />
                ...
                default, APIs e outras integrações externas
            </p >
          </div >
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <Input
                                ...
                                onChange={ ( e ) => setNewIntegration( prev => ( { ...prev, name) ) }
                                placeholder="Ex) => setNewIntegration(prev => ({ ...prev, type, config))}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecione o tipo" />
                            </SelectTrigger>
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={ ( checked ) => setNewIntegration( prev => ( { ...prev, isActive) ) }
                        />
        ...
        ) { integration.id } className = "hover)}
                < div >
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-500">Status)}>
                    ...
                    { integration.lastChecked && (
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-500">Último teste).toLocaleDateString('pt-BR')}
                        </span>
                      </div>
                    ) }
