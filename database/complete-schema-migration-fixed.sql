-- ====================================================================
-- MIGRATION COMPLETA - SCHEMA ROBUSTO TOIT NEXUS (VERSÃO LIMPA)
...
-- ====================================================================
-- LIMPEZA COMPLETA DO BANCO (CUIDADO - REMOVE TUDO)
-- ====================================================================

-- Remover todas as tabelas se existirem (em ordem de dependência)
...
-- ====================================================================
-- 10. CRIAR ÍNDICES (APÓS TODAS AS TABELAS)
-- ====================================================================
...
SELECT 'Schema TOIT Nexus criado com sucesso!' as status;