...
import cardVerificationRoutes from "./cardVerificationRoutes";
...
export async function registerRoutes( app: Express ): Promise<Server>
{
  ...
  // Card Verification routes - Credit card validation for trial
  app.use( '/api/card-verification', cardVerificationRoutes );
